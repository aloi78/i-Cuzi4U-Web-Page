...
export default function CarCleaningPage({ onBack, onWhatsApp }: CarCleaningPageProps) {
  const { t, i18n } = useTranslation();
  const [activeFaq, setActiveFaq] = useState<number | null>(null);

  useEffect(() => {
    // Dynamic SEO updates specifically for the Car Interior Page
    const titles: Record<string, string> = {
      en: "Deep Car Interior & Seat Cleaning Klang Valley | i-Cuzi4U",
      ms: "Servis Cuci Kusyen Kereta & Dalaman Lembah Klang | i-Cuzi4U",
      zh: "巴生谷汽车座椅消毒与织物皮革座椅深层清洁 | i-Cuzi4U"
    };
    
    const descriptions: Record<string, string> = {
      en: "Professional deep car interior & seat cleaning in Klang Valley. Specialized upholstery extraction using eco-friendly Kärcher® technology.",
      ms: "Servis cuci kusyen kereta profesional di Lembah Klang. Basmi kotoran, bau, daki, dan hama habuk dengan teknologi Jerman Kärcher® yang selamat untuk anak & mesra alam.",
      zh: "巴生谷专业汽车座椅与内饰深层抽洗消毒。采用安全环保的德国 Kärcher® 技术，为您深度抽吸汽车织物和皮革座椅，除菌除味、速干防裂。"
    };
  ...
  const problems = [
    ...
    { id: 'spills', icon: <Coffee className="text-[#0D49CD]" size={28} /> },
    { id: 'pet', icon: <Wind className="text-red-400" size={28} /> }
  ];
  ...
  const sizes = [
    {
      id: 'sedan',
      titleKey: 'car_page.sizes.sedan_title',
      priceKey: 'car_page.sizes.sedan_price',
      featuresKey: 'car_page.sizes.sedan_features',
      msg: 'Sedan / Hatchback (Standard 5-Seater)'
    },
    {
      id: 'suv',
      titleKey: 'car_page.sizes.suv_title',
      priceKey: 'car_page.sizes.suv_price',
      featuresKey: 'car_page.sizes.suv_features',
      msg: 'SUV / Crossover (Mid-Size 5-Seater)',
      featured: true
    },
    {
      id: 'mpv',
      titleKey: 'car_page.sizes.mpv_title',
      priceKey: 'car_page.sizes.mpv_price',
      featuresKey: 'car_page.sizes.mpv_features',
      msg: 'MPV / Large SUV (7 to 8-Seater)'
    }
  ];
  ...
  const handleBookClick = (sizeName: string) => {
    const baseMsg = t('car_page.cta_msg');
    onWhatsApp(`${baseMsg} ${sizeName}`);
  };

  return (
    <div className="bg-app-bg min-h-screen" id="car-cleaning-page">
      {/* Breadcrumb Header */}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4 mb-10 max-w-lg">
                  ...
                  <div className="flex items-center gap-2">
                    <CheckCircle2 size={20} className="text-action" />
                    <span className="font-semibold text-sm text-gray-700">Fabric & Leather Restoration</span>
                  </div>
                </div>

                <div className="flex flex-col sm:flex-row gap-4">
                  <button 
                    onClick={() => handleBookClick('SUV / Crossover (Mid-Size 5-Seater)')}
                    className="btn-primary text-lg w-full sm:w-auto animate-pulse-subtle"
                  >
                    <MessageCircle size={22} />
                    <span>{t('car_page.cta_book')}</span>
                  </button>
                  <a 
                    href="#pricing"
            ...
            <div className="lg:col-span-5">
              ...
              >
                <img 
                  src="https://lh3.googleusercontent.com/d/1nF1FCx-D5wv2-PXy5z807saXY3qKl9am"
                  alt="Professional car interior deep cleaning Selangor Kuala Lumpur PJ - i-Cuzi4U"
      ...
      {/* Why Section */}
      <section className="py-20 bg-app-bg" id="car-why-section">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-2xl md:text-4xl font-extrabold text-primary mb-4">
              {t('car_page.why_section_title')}
            </h2>
            <p className="text-gray-600 text-base md:text-lg">
              {t('car_page.why_section_desc')}
            </p>
          </div>
            ...
            {problems.map((prob, idx) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-primary mb-3">
                  {t(`car_page.problems.${prob.id}_title`)}
                </h3>
                <p className="text-gray-500 text-sm leading-relaxed">
                  {t(`car_page.problems.${prob.id}_desc`)}
                </p>
              </motion.div>
            ))}
          </div>
      ...
      {/* Process Section */}
      <section className="py-20 bg-white" id="car-process-section">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-2xl md:text-4xl font-extrabold text-primary mb-4">
              {t('car_page.process_section_title')}
            </h2>
            <p className="text-gray-600 text-base md:text-lg">
              {t('car_page.process_section_desc')}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {stages.map((stage, idx) => (
              ...
              >
                ...
                <h3 className="text-xl font-bold text-primary mb-3">
                  {t(`car_page.stages.${stage}_title`)}
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {t(`car_page.stages.${stage}_desc`)}
                </p>
              </motion.div>
            ))}
          </div>
      ...
      <section id="pricing" className="py-20 bg-app-bg border-y border-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-2xl md:text-4xl font-extrabold text-primary mb-4">
              {t('car_page.pricing_section_title')}
            </h2>
            <p className="text-gray-600 text-base md:text-lg">
              {t('car_page.pricing_section_desc')}
            </p>
          </div>
          ...
          <div className="bg-white border border-gray-100 rounded-[2rem] p-6 md:p-8 max-w-4xl mx-auto mb-12 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex items-center gap-4 justify-center md:justify-start">
              ...
              <div>
                <h4 className="font-extrabold text-primary text-base leading-tight">
                  {t('car_page.highlights.effective_title')}
                </h4>
                <p className="text-xs text-gray-500 font-medium mt-1">
                  {t('car_page.highlights.effective_sub')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 justify-center md:justify-start border-t md:border-t-0 md:border-x border-gray-100 pt-6 md:pt-0 md:px-8">
              ...
              <div>
                <h4 className="font-extrabold text-primary text-base leading-tight">
                  {t('car_page.highlights.dry_title')}
                </h4>
                <p className="text-xs text-gray-500 font-medium mt-1">
                  {t('car_page.highlights.dry_sub')}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 justify-center md:justify-start border-t md:border-t-0 border-gray-100 pt-6 md:pt-0">
              ...
              <div>
                <h4 className="font-extrabold text-primary text-base leading-tight">
                  {t('car_page.highlights.eco_title')}
                </h4>
                <p className="text-xs text-gray-500 font-medium mt-1">
                  {t('car_page.highlights.eco_sub')}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto mb-16">
            <h3 className="text-xl md:text-2xl font-extrabold text-primary text-center mb-8">
              {t('car_page.included_title')}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-4 px-4">
              {(t('car_page.included_items', { returnObjects: true }) as string[]).map((item, index) => (
          ...
          <p className="mt-8 text-center text-xs md:text-sm text-gray-500 font-medium italic leading-relaxed px-4">
            {t('car_page.pricing_note')}
          </p>
        </div>
      </section>

      {/* FAQs Section */}
      <section className="py-20 bg-white" id="car-faq-section">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-2xl md:text-4xl font-extrabold text-primary mb-4">
              {t('car_page.faq_section_title')}
            </h2>
            <p className="text-gray-500">
              {t('car_page.faq_section_desc')}
            </p>
          </div>
      ...
      {/* Mini CTA */}
      <section className="py-16 bg-primary text-white" id="car-mini-cta">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          <h2 className="text-2xl md:text-4xl font-extrabold mb-6">Enjoy a Stain-Free, Sanitized Ride Tonight</h2>
          <p className="text-white/80 mb-8 max-w-xl mx-auto">
            Book our professional on-site car extraction & sanitization services today. Eco-friendly, baby-safe, and highly effective.
          </p>
          <button 
            onClick={() => handleBookClick('SUV / Crossover (Mid-Size 5-Seater)')}
